...
HRS_pain_imputed <- read.csv("pain_HRS_retired_imputed.csv")
...
HRS_pain_imputed[, c(7,17,36:40,41,48,50,52)] <- lapply(HRS_pain_imputed[, c(7,17,36:40,41,48,50,52)], as.factor)
...
HRS_pain_imputed$retired[which(HRS_pain_imputed$retired>0)]<-1
...
t1_unweighted = CreateTableOne(vars = c("age", "agegroup", "sex", "liverural","high_edu","high_edu_parent", "height","race", 
                                        ...
                                        "pain_interfere","pain_med","retired"), 
...
"pain_status","pain_level",
"pain_interfere","pain_med","retired"),data=HRSSvy, addOverall = FALSE,  strata="sex", test = TRUE, includeNA = TRUE)
...
fit<-glm(pain_status ~ female + high_edu, family=binomial(link = "probit"), weights=weight, data=HRS_pain_imputed)
...
fit<-glm(pain_level ~ female + high_edu, family=binomial(link = "probit"), weights=weight, data=subset(HRS_pain_imputed, pain_status == 1))
...
fit<-glm(pain_interfere ~ female + high_edu, family=binomial(link = "probit"), weights=weight, data=subset(HRS_pain_imputed, pain_status == 1))
...
fit<-glm(pain_med ~ female + high_edu, family=binomial(link = "probit"), weights=weight, data=subset(HRS_pain_imputed, pain_status == 1))
...
fit<-glm(pain_status ~ female + high_edu + agegroup + liverural  + height + high_edu_parent + race, family=binomial(link = "probit"), weights=weight, data=subset(HRS_pain_imputed,retired == 1))
...
fit<-glm(pain_level ~ female + high_edu + agegroup + liverural  + height + high_edu_parent + race, family=binomial(link = "probit"), weights=weight, data=subset(HRS_pain_imputed, pain_status == 1 & retired == 1))
...
fit<-glm(pain_interfere ~ female + high_edu + agegroup + liverural  + height + high_edu_parent + race, family=binomial(link = "probit"), weights=weight, data=subset(HRS_pain_imputed, pain_status == 1 & retired == 1))
...
fit<-glm(pain_med ~ female + high_edu + agegroup + liverural  + height + high_edu_parent + race, family=binomial(link = "probit"), weights=weight, data=subset(HRS_pain_imputed, pain_status == 1 & retired == 1))
...
fit<-glm(pain_status ~ female + high_edu + agegroup + liverural  + height + high_edu_parent + race, family=binomial(link = "probit"), weights=weight, data=subset(HRS_pain_imputed,retired == 0))
...
fit<-glm(pain_level ~ female + high_edu + agegroup + liverural  + height + high_edu_parent + race, family=binomial(link = "probit"), weights=weight, data=subset(HRS_pain_imputed, pain_status == 1 & retired == 0))
...
fit<-glm(pain_interfere ~ female + high_edu + agegroup + liverural  + height + high_edu_parent + race, family=binomial(link = "probit"), weights=weight, data=subset(HRS_pain_imputed, pain_status == 1 & retired == 0))
...
fit<-glm(pain_med ~ female + high_edu + agegroup + liverural  + height + high_edu_parent + race, family=binomial(link = "probit"), weights=weight, data=subset(HRS_pain_imputed, pain_status == 1 & retired == 0))
