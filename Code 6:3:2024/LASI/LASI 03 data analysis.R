...
LASI_pain_imputed<-read.csv("pain_lasi_retired_imputed.csv")
...
LASI_pain_imputed[, c(7,15,16,38,40,41,42,48,50,52)] <- lapply(LASI_pain_imputed[, c(7,15,16,38,40,41,42,48,50,52)], as.factor)
...
LASI_pain_imputed$caste<-as.numeric(LASI_pain_imputed$caste)
LASI_pain_imputed$caste[which(LASI_pain_imputed$caste==4)]<-3
LASI_pain_imputed$caste<-as.factor(LASI_pain_imputed$caste)
# 1: scheduled caste
# 2: scheduled tribe
# 3: General or none or other backward caste

#Unweighted, use N
#overall
t1_unweighted = CreateTableOne(vars = c("age", "agegroup", "sex","liverural", "high_edu", "high_edu_parent", "height","caste", "pain_status","pain_interfere","pain_med","retired"), 
							   data=LASI_pain_imputed, includeNA = TRUE)
...
#stratified by sex
t1_unweighted_stratified = CreateTableOne(vars = c("age", "agegroup", "sex","liverural", "high_edu", "high_edu_parent", "height","caste", "pain_status","pain_interfere","pain_med","retired"), 
										  data=LASI_pain_imputed, addOverall = FALSE,  strata="sex", test = TRUE, includeNA = TRUE)
...
charlsSvy <- svydesign(ids = ~ ID, weights = ~ weight, nest = FALSE, data = LASI_pain_imputed)

#overall
t1_weighted <- svyCreateTableOne(vars = c("age", "agegroup", "sex","liverural", "high_edu", "high_edu_parent", "height","caste", "pain_status","pain_interfere","pain_med","retired"),
...
#stratified by sex
t1_weighted_stratified <- svyCreateTableOne(vars = c("age", "agegroup", "sex","liverural", "high_edu", "high_edu_parent", "height","caste", "pain_status","pain_interfere","pain_med","retired"),
											data=charlsSvy, addOverall = FALSE,  strata="sex", test = TRUE, includeNA = TRUE)
...
fit<-glm(pain_status ~ female + high_edu, family=binomial(link = "probit"), weights=weight, data=LASI_pain_imputed)
...
fit<-glm(pain_interfere ~ female + high_edu, family=binomial(link = "probit"), weights=weight, data=subset(LASI_pain_imputed, pain_status == 1))
...
fit<-glm(pain_med ~ female + high_edu, family=binomial(link = "probit"), weights=weight, data=subset(LASI_pain_imputed, pain_status == 1))
...
fit<-glm(pain_status ~ female + high_edu + agegroup + liverural  + height + high_edu_parent + caste, family=binomial(link = "probit"), weights=weight, data=subset(LASI_pain_imputed,retired==1))
...
fit<-glm(pain_interfere ~ female + high_edu + agegroup + liverural  + height + high_edu_parent + caste, family=binomial(link = "probit"), weights=weight, data=subset(LASI_pain_imputed, pain_status == 1 & retired==1))
...
fit<-glm(pain_med ~ female + high_edu + agegroup + liverural  + height + high_edu_parent + caste, family=binomial(link = "probit"), weights=weight, data=subset(LASI_pain_imputed, pain_status == 1 & retired==1))
...
fit<-glm(pain_status ~ female + high_edu + agegroup + liverural  + height + high_edu_parent + caste, family=binomial(link = "probit"), weights=weight, data=subset(LASI_pain_imputed,retired==0))
...
fit<-glm(pain_interfere ~ female + high_edu + agegroup + liverural  + height + high_edu_parent + caste, family=binomial(link = "probit"), weights=weight, data=subset(LASI_pain_imputed, pain_status == 1 & retired==0))
...
fit<-glm(pain_med ~ female + high_edu + agegroup + liverural  + height + high_edu_parent + caste, family=binomial(link = "probit"), weights=weight, data=subset(LASI_pain_imputed, pain_status == 1 & retired==0))
